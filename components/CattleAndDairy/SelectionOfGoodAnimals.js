...
const selectionList = [
  {
    ...
    description: "selectionOfGoodAnimals.pictureOfGoodDairyAnimal",
  },
  {
    id: 2,
    img: require("../../assets/images/selection2.jpeg"),
    description: "selectionOfGoodAnimals.wedgeShapedBody",
  },
  {
    id: 3,
    img: require("../../assets/images/selection3.jpeg"),
    description: "selectionOfGoodAnimals.smoothShiningCoat",
  },
  {
    id: 4,
    img: require("../../assets/images/selection4.jpeg"),
    description: "selectionOfGoodAnimals.shortNeck",
  },
  {
    id: 5,
    img: require("../../assets/images/selection5.jpeg"),
    description: "selectionOfGoodAnimals.largeVoluminousUdder",
  },
  {
    id: 6,
    img: require("../../assets/images/selection6.jpeg"),
    description: "selectionOfGoodAnimals.squarelyPlacedTeats",
  },
  {
    id: 7,
    img: require("../../assets/images/selection7.jpeg"),
    description: "selectionOfGoodAnimals.goodCapillaryNetwork",
  },
];
...
export default function SelectionOfGoodAnimals({ navigation }) {
  return (
    ...
    <View style={styles.screen}>
      ...
      >
        {i18n.t("selectionOfGoodAnimals.selectionOfGoodAnimals")}
      </Text>
      <Text
        style={{
          textAlign: "center",
      ...
      >
        <Text style={{ color: "#2d2121", fontSize: 16, fontWeight: "600" }}>
          {i18n.t("selectionOfGoodAnimals.selection")}{" "}
        </Text>
        {i18n.t("selectionOfGoodAnimals.selectionOfGoodAnimalsDescription")}
      </Text>
      <FlatList
        data={selectionList}
